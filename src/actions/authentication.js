...
export const registrationSuccess = () => ({ type: 'AUTHENTICATION_REGISTRATION_SUCCESS' });// Check user session
...
export function registerUser(userData) {
  return async (dispatch) => {
    ...
    .catch((error) => {
       dispatch(registrationFailure(new Error(error.message || 'Registration Failed. Please try again.'))); // use msg if exists, else send ours
    });
